...
import net.tywrapstudios.ctd.discord.resources.Author;
import net.tywrapstudios.ctd.discord.resources.Field;
import net.tywrapstudios.ctd.discord.resources.Footer;
import net.tywrapstudios.ctd.discord.resources.Image;
